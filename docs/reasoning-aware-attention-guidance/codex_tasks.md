...
docs/reasoning-aware-attention-guidance/*_interface.md 与 src/recover_attention/schemas.py 的 REQUIRED_FIELDS 为准，
...
方法概念应放在 `docs/reasoning-aware-attention-guidance/method.md`。
...
2. 字段语义、示例和校验规则以对应 docs/reasoning-aware-attention-guidance/<artifact>_interface.md 为准。
