...
docs/skill/ablated_questions_interface.md 已存在。
```
...
```text
docs/skill/SKILL.md 只允许增加 nli_scores_interface.md 的文档索引行。
```
...
7. 当前 docs/skill/ablated_questions_interface.md 是否存在
8. 当前 docs/skill/nli_scores_interface.md 是否存在
...
```text
1. docs/skill/nli_scores_interface.md 存在。
2. docs/skill/SKILL.md 已增加 nli_scores_interface.md 索引行。
