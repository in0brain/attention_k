...
docs/reasoning-aware-attention-guidance/ablated_questions_interface.md 可以创建或更新。

docs/reasoning-aware-attention-guidance/SKILL.md 只允许增加 ablated_questions_interface.md 的索引行。
```
...
README.md
AGENTS.md
docs/reasoning-aware-attention-guidance/*（除 docs/reasoning-aware-attention-guidance/ablated_questions_interface.md，以及 docs/reasoning-aware-attention-guidance/SKILL.md 的索引行外）
docs/reference/*
docs/codex_tasks/*
configs/*
requirements.txt
...
Sprint 1C 的输入必须符合 `docs/reasoning-aware-attention-guidance/ablation_units_interface.md`。

Sprint 1C 的输出必须符合 `docs/reasoning-aware-attention-guidance/ablated_questions_interface.md`。
...
23. data/processed/ablated_questions.jsonl 符合 docs/reasoning-aware-attention-guidance/ablated_questions_interface.md。
24. validate_ablated_question_record 与 docs/reasoning-aware-attention-guidance/ablated_questions_interface.md 中的 schema 约束一致。
```
